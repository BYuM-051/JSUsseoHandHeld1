...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_height(ui_SC1_Body_Panel, 396);
    lv_obj_set_x(ui_SC1_Body_Panel, 12);
    lv_obj_set_y(ui_SC1_Body_Panel, 72);
    lv_obj_clear_flag(ui_SC1_Body_Panel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_DebugLabel = lv_label_create(ui_SC1_Body_Panel);
    ...
    ui_SerialLabel = lv_label_create(ui_SC1_Body_Panel);
